...
\programming{
    {PHP $\textbullet$ Go $\textbullet$ R $\textbullet$ \large \LaTeX / 1.5},
    {Python $\textbullet$ TypeScript $\textbullet$ Redis $\textbullet$ Matlab / 3.5},
    {JavaScript $\textbullet$ HTML5 $\textbullet$ CSS $\textbullet$ SQL / 4.5},
